...
namespace ProjectSample.Migrations
{
    ...
    public class AddedShipments : Migration
    {
        public override void Up()
        {
            ...
            Create.ForeignKey("FK9E65A959871A04D2").FromTable("Shipment").InSchema("dbo").ForeignColumns("OrderId").ToTable("Order").InSchema("dbo").PrimaryColumns("Id");

            // Foreign keys for table: ShipmentItem.
            Create.ForeignKey("FKA7C3996E6373F36E").FromTable("ShipmentItem").InSchema("dbo").ForeignColumns("ShipmentId").ToTable("Shipment").InSchema("dbo").PrimaryColumns("Id");
            Create.ForeignKey("FKA7C3996E430F7AB8").FromTable("ShipmentItem").InSchema("dbo").ForeignColumns("OrderItemId").ToTable("OrderItem").InSchema("dbo").PrimaryColumns("Id");
